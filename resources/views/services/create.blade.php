...
<div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="business_name" type="text" class="form-control @error('business_name') is-invalid @enderror" business_name="business_name" value="{{ old('business_name') }}" required autocomplete="business_name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="business_type" type="text" class="form-control @error('business_type') is-invalid @enderror" business_type="business_type" value="{{ old('business_type') }}" required autocomplete="business_type" autofocus>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="business_phone_number" type="text" class="form-control @error('business_phone_number') is-invalid @enderror" business_phone_number="business_phone_number" value="{{ old('business_phone_number') }}" required autocomplete="business_phone_number" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="mobile_phone_number" type="text" class="form-control @error('mobile_phone_number') is-invalid @enderror" mobile_phone_number="mobile_phone_number" value="{{ old('mobile_phone_number') }}" required autocomplete="mobile_phone_number" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="image" type="image" class="form-control @error('image') is-invalid @enderror" name="image" value="{{ old('image') }}" required autocomplete="image">
